			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					case BasicCubeNetworkObject.IDENTITY:
						...
						break;
					case CardGameManagerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new CardGameManagerNetworkObject(networker, id, frame);
						break;
					case CardGamePlayerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new CardGamePlayerNetworkObject(networker, id, frame);
						break;
